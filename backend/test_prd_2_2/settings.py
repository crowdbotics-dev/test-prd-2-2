"""
Django settings for test_prd_2_2 project.
...
ROOT_URLCONF = 'test_prd_2_2.urls'
...
WSGI_APPLICATION = 'test_prd_2_2.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "test-prd-2 Support <support@test-prd-2-2.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "test_prd_2_2 API",
    "DESCRIPTION": "API documentation for test_prd_2_2 App",
    "VERSION": "v1",
}
